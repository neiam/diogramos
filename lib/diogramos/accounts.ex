defmodule Diogramos.Accounts do
  @moduledoc """
  ...
  alias Diogramos.Accounts.{User, UserToken, UserNotifier}
  ...
  @doc """
  Registers an anonymous user. Used by the share-link redemption flow
  ...
  alias Diogramos.Accounts.Invite
  ...
  def registration_open? do
    Application.get_env(:diogramos, :registration_open, false) == true
  end
  ...
  See `Diogramos.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Diogramos.Accounts.User.password_changeset/3` for a list of supported options.
